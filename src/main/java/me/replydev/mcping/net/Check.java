...
public class Check implements Runnable {
    ...
    public static Logger logger = LogManager.getLogger(Check.class);
    ...
    public Check(ServerRepository repository,String hostname, int port, int timeout, String filename, int count, QuboInstance quboInstance, String filterVersion, String filterMotd, int minPlayer) {
